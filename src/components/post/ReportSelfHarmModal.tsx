...
interface ReportSelfHarmModalProps {
  onClose: () => void
  onBack: () => void
  onSubmit: () => void
}

const SELF_HARM_REASONS = ['자살 또는 자해', '섭식 장애']

export default function ReportSelfHarmModal({
  onClose,
  onBack,
  onSubmit,
}: ReportSelfHarmModalProps) {
  return (
    <div
