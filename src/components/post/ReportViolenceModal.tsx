...
interface ReportViolenceModalProps {
  onClose: () => void
  onBack: () => void
  onSubmit: () => void
}

const VIOLENCE_REASONS = [
  '폭력성 및 자극적인 콘텐츠',
  '사망 또는 심각한 부상',
  '동물 학대',
  '성폭력',
...
export default function ReportViolenceModal({
  onClose,
  onBack,
  onSubmit,
}: ReportViolenceModalProps) {
  return (
    <div
